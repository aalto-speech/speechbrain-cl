#!/usr/bin/env python3
"""
Recipe for training a Voice Activity Detection (VAD) model on (adjusted on LibriParty recipe).
This code heavily relies on data augmentation with external datasets.
(e.g, open_rir, musan).
...
def dataio_prep(hparams):
    ...
    def vad_targets(speech, hparams=hparams):
        # NOTE: WE DON'T HAVE LABELED BOUNDARIES FOR LP
        boundaries = (
            [
                (
